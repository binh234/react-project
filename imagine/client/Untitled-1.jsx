...
const getKey2 = (pageIndex, previousPageData, repo, pageSize) => {
  if (previousPageData && !previousPageData.length) return null // reached the end

  return `https://api.github.com/repos/${repo}/issues?per_page=${pageSize}&page=${pageIndex + 1}`
}
...
const getKey = (pageIndex, previousPageData, prompt, name, tags, limit) => {
  ...
  const searchParams = new URLSearchParams({
    ...
    tags: tags,
    limit: limit,
    cursor: previousPageData[previousPageData.length - 1].date,
  })
...
//   const { data, error, mutate, size, setSize, isValidating } = useSWRInfinite(
//     (...args) => getKey2(...args, repo, PAGE_SIZE),
//     fetcher
//   )
  ...
  const isReachingEnd =
    !isLoadingMore && (!posts.length || (size > 0 && data && !data[size - 1].length))

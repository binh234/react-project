...
const Detail = ({ postDetails }: IProps) => {
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-0 bg-white flex-wrap md:flex-nowrap'>
      <div className='relative flex-2 w-full md:w-9/12 flex justify-center items-center bg-black'>
        <div className='absolute top-6 left-2 lg:left-6 flex gap-6 z-50'>
          <p className='cursor-pointer text-white hover:text-gray-200' onClick={() => router.back()}>
          ...
          <div>
            <Link href={`/detail/${post._id}`}>
              <div className='flex flex-col gap-1'>
                <p className='flex gap-1 items-center md:text-md text-primary font-bold'>{post.postedBy.userName} {` `}
